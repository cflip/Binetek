...
import com.cflip.binetek.block.SulfurOreBlock;
	...
	public static class RegistryEvents {
		...
		public static void registerItems(final RegistryEvent.Register<Item> event) {
			event.getRegistry().registerAll(
				...
				ItemList.copperPickaxe = new PickaxeItem(CopperItemTier.instance, 1, -2.8f, new Item.Properties().group(BinetekItemGroup.instance)).setRegistryName(Binetek.MODID, "copper_pickaxe"),
				ItemList.copperAxe = new AxeItem(CopperItemTier.instance, 6, -3.1f, new Item.Properties().group(BinetekItemGroup.instance)).setRegistryName(Binetek.MODID, "copper_axe"),
				ItemList.copperShovel = new ShovelItem(CopperItemTier.instance, 1.5f, -3, new Item.Properties().group(BinetekItemGroup.instance)).setRegistryName(Binetek.MODID, "copper_shovel"),
				ItemList.copperHoe = new HoeItem(CopperItemTier.instance, -1.5f, new Item.Properties().group(BinetekItemGroup.instance)).setRegistryName(Binetek.MODID, "copper_hoe"),
				ItemList.copperSword = new SwordItem(CopperItemTier.instance, 3, -2.4f, new Item.Properties().group(BinetekItemGroup.instance)).setRegistryName(Binetek.MODID, "copper_sword"),
		...
		public static void registerBlocks(final RegistryEvent.Register<Block> event) {
			event.getRegistry().registerAll(
				...
				BlockList.sulfurOre = new SulfurOreBlock().setRegistryName(Binetek.MODID, "sulfur_ore"),
